...
-file("lib/chat/language/compiler/process_lexer.xrl", 99).
...
yystate(68, [85|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [86|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [84|Ics], Line, Tlen, Action, Alen) ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [83|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [79|Ics], Line, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [74|Ics], Line, Tlen, Action, Alen) ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [73|Ics], Line, Tlen, Action, Alen) ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [71|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(68, [68|Ics], Line, Tlen, Action, Alen) ->
    yystate(37, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [66|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [67|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(68, [59|Ics], Line, Tlen, Action, Alen) ->
...
yystate(68, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(70, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [C|Ics], Line, Tlen, Action, Alen) when C >= 75, C =< 78 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [C|Ics], Line, Tlen, Action, Alen) when C >= 80, C =< 82 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(68, [C|Ics], Line, Tlen, Action, Alen) when C >= 88, C =< 90 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(67, [77|Ics], Line, Tlen, _, _) ->
    yystate(71, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(59, [82|Ics], Line, Tlen, _, _) ->
    yystate(63, Ics, Line, Tlen+1, 37, Tlen);
yystate(59, [80|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(59, [81|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(59, [79|Ics], Line, Tlen, _, _) ->
    yystate(69, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 72 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 74, C =< 82 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(47, [78|Ics], Line, Tlen, _, _) ->
    yystate(51, Ics, Line, Tlen+1, 37, Tlen);
yystate(47, [70|Ics], Line, Tlen, _, _) ->
    yystate(55, Ics, Line, Tlen+1, 37, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 69 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 71, C =< 77 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(44, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(44, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(44, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(35, [73|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(31, [95|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(31, [79|Ics], Line, Tlen, _, _) ->
    yystate(35, Ics, Line, Tlen+1, 37, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 77 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 79, C =< 81 ->
    yystate(24, Ics, Line, Tlen+1, 37, Tlen);
...
yystate(4, [69|Ics], Line, Tlen, _, _) ->
    yystate(0, Ics, Line, Tlen+1, 37, Tlen);

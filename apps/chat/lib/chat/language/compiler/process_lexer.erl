...
-file("lib/chat/language/compiler/process_lexer.xrl", 101).
...
yystate(73, [82|Ics], Line, Tlen, _, _) ->
    yystate(71, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(70, [66|Ics], Line, Tlen, Action, Alen) ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(70, [67|Ics], Line, Tlen, Action, Alen) ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
...
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 75, C =< 78 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 80, C =< 82 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 88, C =< 90 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
...
yystate(67, [78|Ics], Line, Tlen, _, _) ->
    yystate(63, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(64, [10|Ics], Line, Tlen, _, _) ->
    yystate(68, Ics, Line+1, Tlen+1, 1, Tlen);
yystate(64, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line,64};
yystate(63, [95|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(63, [68|Ics], Line, Tlen, _, _) ->
    yystate(59, Ics, Line, Tlen+1, 38, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 67 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 69, C =< 90 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(57, [95|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(57, [82|Ics], Line, Tlen, _, _) ->
    yystate(61, Ics, Line, Tlen+1, 38, Tlen);
yystate(57, [80|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(57, [81|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(57, [C|Ics], Line, Tlen, _, _) when C >= 83, C =< 90 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(55, [73|Ics], Line, Tlen, _, _) ->
    yystate(43, Ics, Line, Tlen+1, 38, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 72 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 74, C =< 82 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(52, [95|Ics], Line, Tlen, Action, Alen) ->
    yystate(52, Ics, Line, Tlen+1, Action, Alen);
yystate(52, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(52, Ics, Line, Tlen+1, Action, Alen);
...
yystate(46, [72|Ics], Line, Tlen, _, _) ->
    yystate(42, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 69 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 71, C =< 77 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(33, [95|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(33, [73|Ics], Line, Tlen, _, _) ->
    yystate(37, Ics, Line, Tlen+1, 38, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 72 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 74, C =< 90 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 77 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 79, C =< 81 ->
    yystate(26, Ics, Line, Tlen+1, 38, Tlen);
...
-file("lib/chat/language/compiler/process_lexer.xrl", 90).
yyaction_32(TokenLine) ->
     { token, { where, TokenLine } } .

-compile({inline,yyaction_33/1}).
-file("lib/chat/language/compiler/process_lexer.xrl", 91).
yyaction_33(TokenLine) ->
     { token, { join, TokenLine } } .

-compile({inline,yyaction_34/1}).
-file("lib/chat/language/compiler/process_lexer.xrl", 92).
yyaction_34(TokenLine) ->
     { token, { on, TokenLine } } .

-compile({inline,yyaction_35/2}).
-file("lib/chat/language/compiler/process_lexer.xrl", 94).
yyaction_35(TokenChars, TokenLine) ->
     { token, { num, TokenLine, trim_num (TokenChars) } } .

-compile({inline,yyaction_36/2}).
-file("lib/chat/language/compiler/process_lexer.xrl", 95).
yyaction_36(TokenChars, TokenLine) ->
     { token, { str, TokenLine, trim_str (TokenChars) } } .

-compile({inline,yyaction_37/2}).
-file("lib/chat/language/compiler/process_lexer.xrl", 96).
yyaction_37(TokenChars, TokenLine) ->
     { token, { var, TokenLine, trim_var (TokenChars) } } .

-compile({inline,yyaction_38/2}).
-file("lib/chat/language/compiler/process_lexer.xrl", 97).
yyaction_38(TokenChars, TokenLine) ->

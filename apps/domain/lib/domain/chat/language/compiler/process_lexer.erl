...
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.erl", 313).
yystate() -> 66.
...
yystate(67, [70|Ics], Line, Tlen, _, _) ->
    yystate(59, Ics, Line, Tlen+1, 26, Tlen);
yystate(67, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(67, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 69 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(67, [C|Ics], Line, Tlen, _, _) when C >= 71, C =< 77 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(66, [87|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [86|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [85|Ics], Line, Tlen, Action, Alen) ->
...
yystate(66, [74|Ics], Line, Tlen, Action, Alen) ->
    yystate(57, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [73|Ics], Line, Tlen, Action, Alen) ->
    yystate(67, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [71|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [72|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
...
yystate(66, [66|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [67|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [65|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [61|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [59|Ics], Line, Tlen, Action, Alen) ->
...
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 75, C =< 78 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 80, C =< 82 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Tlen, Action, Alen) when C >= 88, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
...
yystate(63, Ics, Line, Tlen, _, _) ->
    {11,Tlen,Ics,Line,63};
yystate(62, [95|Ics], Line, Tlen, Action, Alen) ->
    yystate(58, Ics, Line, Tlen+1, Action, Alen);
yystate(62, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(58, Ics, Line, Tlen+1, Action, Alen);
yystate(62, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(58, Ics, Line, Tlen+1, Action, Alen);
yystate(62, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(58, Ics, Line, Tlen+1, Action, Alen);
...
yystate(60, [10|Ics], Line, Tlen, _, _) ->
    yystate(64, Ics, Line+1, Tlen+1, 1, Tlen);
...
yystate(55, [80|Ics], Line, Tlen, _, _) ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(55, [81|Ics], Line, Tlen, _, _) ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(53, Ics, Line, Tlen, _, _) ->
    {25,Tlen,Ics,Line,53};
yystate(52, [61|Ics], Line, Tlen, Action, Alen) ->
...
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 77 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(45, [C|Ics], Line, Tlen, _, _) when C >= 79, C =< 81 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(37, [95|Ics], Line, Tlen, _, _) ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(37, [84|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line, Tlen+1, 26, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 83 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 85, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 68, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 75 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 82 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 84, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 67 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 69, C =< 90 ->
    yystate(16, Ics, Line, Tlen+1, 26, Tlen);
...
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.xrl", 42).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.xrl", 43).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/1}).
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.xrl", 45).
yyaction_2(TokenLine) ->
     { token, { dot, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.xrl", 46).
yyaction_3(TokenLine) ->
...
-file("apps/domain/lib/domain/chat/language/compiler/process_lexer.xrl", 49).
yyaction_6(TokenLine) ->
     { token, { lif, TokenLine } } .

...
Nonterminals
comp_op logical_op string identifier variable variable_list program stmt stmts stmts_paren expr if_stmt unless_stmt for_stmt logical_expr comp_expr function_expr expr_list.

Terminals
comma sep lif unless then else for in do with land lor equals not_equals left_paren right_paren ident var str.

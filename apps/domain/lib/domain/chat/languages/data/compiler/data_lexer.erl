...
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 37).
...
-file("lib/domain/chat/languages/data/compiler/data_lexer.erl", 313).
yystate() -> 28.
...
yystate(28, [87|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [83|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 69 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 82 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 84, C =< 86 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 88, C =< 90 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, 9, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 68, C =< 90 ->
    yystate(9, Ics, Line, Tlen+1, 9, Tlen);
...
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 20).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 21).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 23).
yyaction_2(TokenLine) ->
     { token, { comma, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 24).
yyaction_3(TokenLine) ->
     { token, { all, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 25).
yyaction_4(TokenLine) ->
     { token, { select, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 26).
yyaction_5(TokenLine) ->
     { token, { from, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 27).
yyaction_6(TokenLine) ->
     { token, { where, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 28).
yyaction_7(TokenLine) ->
     { token, { equals, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 29).
yyaction_8(TokenLine) ->
...
-file("lib/domain/chat/languages/data/compiler/data_lexer.xrl", 33).
yyaction_11(TokenChars, TokenLine) ->
